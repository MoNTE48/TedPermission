...
public abstract class TedPermissionBase {
    ...
    public static boolean canRequestPermission(AppCompatActivity activity, @NonNull String... permissions) {
    ...
    public static void startSettingActivityForResult(AppCompatActivity activity) {
        startSettingActivityForResult(activity, REQ_CODE_REQUEST_SETTING);
    }

    public static void startSettingActivityForResult(AppCompatActivity activity, int requestCode) {
